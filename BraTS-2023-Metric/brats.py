"""
COMMENTED OUT VERSION OF THE ORIGINAL REPO - https://github.com/rachitsaluja/BraTS-2023-Metrics/blob/main/metrics.py

ONLY PRINTS THE ACTUAL (LESION-WISE BRATS) DICE SCORE
"""
